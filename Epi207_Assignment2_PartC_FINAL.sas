...
%let workdir = C:\....;/*define the working directory where the data is stored*/
libname epi207 "&workdir";

/* Load data */
proc import datafile="&workdir.data.xlsx" dbms=xlsx out=data replace;/*dataa should be replaced with the name of dataset*/
run;
